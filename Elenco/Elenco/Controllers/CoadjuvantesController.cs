...
namespace Elenco.Controllers
{
    public class CoadjuvantesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Descricao,Retrato,Origem")] Coadjuvante coadjuvante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Descricao,Retrato,Origem")] Coadjuvante coadjuvante)
        {
